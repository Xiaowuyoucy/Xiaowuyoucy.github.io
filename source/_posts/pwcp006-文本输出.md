    ...
    case WM_PAINT:
        {
			...
			for (int i = 0; i < 100; i++)
			{
				_sntprintf(szBuffer,1024, TEXT("我爱你 %d"),i + 1);
				TextOut(hdc, 0, iCharWidth * i,szBuffer , lstrlen(szBuffer));
			}
